...
- 2026-08-29 隔离发货真实回归：部署 C-PC 的已审核买手会话对订单 `2093370220756951040` 提交顺丰测试运单 `QA-CPC-20260829-0001` 后成功提示，卖出订单和详情均从“采购中”回读为“运输中”；详情显示承运商、运单号和“包裹已交承运商”轨迹。顾客通知与订单三方群均出现发货消息，页面控制台无新增 warning/error。顾客签收与评价仍需取得该订单所属顾客的已登录测试会话后继续，不能以其他买手会话替代。
